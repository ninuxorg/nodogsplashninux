...
<div class=\"content community\">
	...
	Senza dubbio il modo migliore per conoscerci meglio è partecipare alle nostre <a href=\"authaction?redir=http%3A%2F%2Fwiki.ninux.org%2FRiunioni&tok=token\" target=\"_blank\" title=\"Richiede inoltro ad Internet\">riunioni</a>, iscriversi alla <a href=\"authaction?redir=http%3A%2F%2Fwiki.ninux.org%2FMailingLists&tok=token\" target=\"_blank\" title=\"Richiede inoltro ad Internet\">Mailing List</a> o anche partecipando ai nostri <a href=\"authaction?redir=http%3A%2F%2Fwiki.ninux.org%2FEventi&tok=token\" target=\"_blank\" title=\"Richiede inoltro ad Internet\">eventi</a>.<br />
	Puoi anche contribuire al nostro sviluppo dandoci una mano:
	<ul>
		<li>Creando un nodo anche tu altrove ed espandere la nostra rete. Consulta la mappa: <a href=\"authaction?redir=http%3A%2F%2Fmap.ninux.org&tok=token\" target=\"_blank\" title=\"Richiede inoltro ad Internet\">map.ninux.org</a></li>
		<li>Migliorando il nostro <a href=\"authaction?redir=http%3A%2F%2Fwiki.ninux.org%2FComeWikizzare&tok=token\" target=\"_blank\" title=\"Richiede inoltro ad Internet\">wiki</a></li>
		<li>Con il passaparola</li>
		<li>Facendoci una <form method=\"post\" action=\"authaction?redir=https%3A%2F%2Fwww.paypal.com%2Fcgi-bin%2Fwebscr&tok=token\" target=\"_blank\" title=\"Richiede inoltro ad Internet\" style=\"display: inline; vertical-align: -9px; margin-left: 5px;\"><input type=\"hidden\" value=\"_donations\" name=\"cmd\"><input type=\"hidden\" value=\"contatti@ninux.org\" name=\"business\"><input type=\"hidden\" value=\"IT\" name=\"lc\"><input type=\"hidden\" value=\"Ninux.org\" name=\"item_name\"><input type=\"hidden\" value=\"0\" name=\"no_note\"><input type=\"hidden\" value=\"EUR\" name=\"currency_code\"><input type=\"hidden\" value=\"PP-DonationsBF:btn_donate_LG.gif:NonHostedGuest\" name=\"bn\"><input type=\"image\" alt=\"PayPal - Il sistema di pagamento online più facile e sicuro!\" name=\"submit\" src=\"/images/btn_donate_LG.gif\" style=\"border: 0px none;\" /><img width=\"1\" height=\"1\" src=\"/images/pixel.gif\" alt=\"\" style=\"border: 0px none;\" /></form></li>
	</ul>
</div>
